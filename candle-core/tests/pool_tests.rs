...
test_device!(avg_pool2d, avg_pool2d_cpu);
test_device!(avg_pool2d_pytorch, avg_pool2d_pytorch_cpu);
test_device!(max_pool2d, max_pool2d_cpu);
test_device!(upsample_nearest2d, upsample_nearest2d_cpu);
