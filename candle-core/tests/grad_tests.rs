...
test_device!(simple_grad, simple_grad_cpu);
test_device!(sum_grad, sum_grad_cpu);
test_device!(matmul_grad, matmul_grad_cpu);
test_device!(grad_descent, grad_descent_cpu);
test_device!(unary_grad, unary_grad_cpu);
test_device!(binary_grad, binary_grad_cpu);
